...
from phonetic_bootstrapping.analysis.jaccard import jaccard
from phonetic_bootstrapping.analysis.cues import cue_measures
from phonetic_bootstrapping.analysis.outcomes import outcome_measures
...
def get_cue_and_outcome_measures(associations, row_ids, col_ids, celex_dir, plot_path,
    ...
    jaccard_values = jaccard(associations, row_ids, col_ids, celex_dir, plot_path, stress_marker=stress_marker,
                             uniphone=uniphones, diphone=diphones, triphone=triphones, syllable=syllable)
