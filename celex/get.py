...
from celex.phonology.words import read_epw
from celex.phonology.lemmas import read_epl
from celex.morphology.words import read_emw
from celex.morphology.lemmas import read_eml
